			...
			$schema = [
				'historico_vt' => [
					...
					'VcrDir' => [
						...
						'info' => [
							'caption' => 'DIRECCION:',
							'description' => 'Direcci&#243;n donde se realiz&#243; la visita de verificaci&#243;n de condiciones de riesgo de origen natural, socio natural y tecnol&#243;gico. ',
						],
					],
					'VcrIdBarVe' => [
						...
						'info' => [
							'caption' => 'BARRIO:',
							'description' => 'Barrio donde se realiz&#243; la visita de verificaci&#243;n',
						],
					],
					'VcrIdCom' => [
