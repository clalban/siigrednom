<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'comunas' table. 
	...
	*/
	...
	function comunas_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function comunas_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function comunas_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function comunas_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function comunas_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function comunas_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function comunas_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function comunas_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function comunas_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function comunas_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function comunas_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function comunas_batch_actions(&$args) {
