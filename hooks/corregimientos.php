<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'corregimientos' table. 
	...
	*/
	...
	function corregimientos_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function corregimientos_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function corregimientos_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function corregimientos_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function corregimientos_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function corregimientos_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function corregimientos_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function corregimientos_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function corregimientos_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function corregimientos_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function corregimientos_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function corregimientos_batch_actions(&$args) {
