<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'barrios' table. 
	...
	*/
	...
	function barrios_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function barrios_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function barrios_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function barrios_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function barrios_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['VcrIdBarVe'], $data['VcrBarVer'], $data['VcrIdCom']
	...
	*/
	...
	function barrios_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function barrios_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function barrios_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function barrios_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function barrios_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function barrios_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function barrios_batch_actions(&$args) {
