<?php
	...
	*/
	 ...
	 * For this table, the array items are: 
	 *     $data['VcrDir'], $data['VcrIdBarVe'], $data['VcrIdCom'], $data['VcrIdCorr'], $data['VcrDirNom']
	...
	*/
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['VcrId'], $data['VcrDir'], $data['VcrIdBarVe'], $data['VcrIdCom'], $data['VcrIdCorr'], $data['VcrDirNom']
