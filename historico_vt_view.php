...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->QueryFieldsTV = [
		...
		"IF(    CHAR_LENGTH(`comunas1`.`VcrIdCom`), CONCAT_WS('',   `comunas1`.`VcrIdCom`), '') /* COMUNA: */" => "VcrIdCom",
	...
	$x->QueryFieldsFilters = [
		...
		"IF(    CHAR_LENGTH(`comunas1`.`VcrIdCom`), CONCAT_WS('',   `comunas1`.`VcrIdCom`), '') /* COMUNA: */" => "COMUNA:",
